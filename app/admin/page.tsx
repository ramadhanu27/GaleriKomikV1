      ...
      <div className="container-custom py-8">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              href="/admin/manga"
              className="group bg-slate-800/50 hover:bg-slate-800 border-2 border-slate-700 hover:border-purple-500 rounded-xl p-6 transition-all"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Manga</h3>
                  <p className="text-sm text-slate-400">Manage manga library</p>
                </div>
              </div>
            </Link>
            ...
            <Link
              ...
              className="group bg-slate-800/50 hover:bg-slate-800 border-2 border-slate-700 hover:border-blue-500 rounded-xl p-6 transition-all"
            >
              <div className="flex items-center gap-4">
            ...
            <Link
              href="/admin/settings"
              className="group bg-slate-800/50 hover:bg-slate-800 border-2 border-slate-700 hover:border-green-500 rounded-xl p-6 transition-all"
            >
              <div className="flex items-center gap-4">
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="group bg-slate-800/50 hover:bg-slate-800 border-2 border-slate-700 hover:border-red-500 rounded-xl p-6 transition-all inline-flex items-center gap-4"
          >
