...
import { isBookmarked, toggleBookmark } from "@/lib/localBookmark";
                  ...
                  <button
                    onClick={() => {
                      const result = toggleBookmark({
                        ...
                        type: manhwa.details.type,
                      });
                      setBookmarked(result);
                    }}
                    className={`px-6 py-3 font-semibold rounded-lg transition-all flex items-center gap-2 ${
                      bookmarked ? "bg-primary-600 text-white hover:bg-primary-700" : "bg-slate-700/50 text-white hover:bg-slate-700 border border-slate-600/50"
                    }`}>
