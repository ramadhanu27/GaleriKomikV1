...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-sm text-slate-400 font-medium">Share:</span>
      
      {/* Copy Link */}
      <button
        onClick={handleCopyLink}
        className="p-2 bg-slate-700/50 hover:bg-slate-700 text-white rounded-lg transition-all group relative"
        title="Copy Link"
      >
        {copied ? (
