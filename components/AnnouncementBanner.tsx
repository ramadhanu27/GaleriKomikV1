  ...
  return (
    <div className="mb-8 space-y-4">
      {visibleAnnouncements.map((announcement) => (
        <div key={announcement.id} className={`bg-gradient-to-r ${getTypeStyles(announcement.type)} border rounded-xl p-6 relative overflow-hidden`}>
          {/* Background Pattern */}
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-200 text-sm leading-relaxed mb-3">{announcement.message}</p>
